...
# Try to detect the Vulkan version. find_file() only searches when the
# variable is unset, not when it is defined as an empty string.
unset(VULKAN_CORE_H CACHE)
unset(VULKAN_CORE_H)

# Try to detect the Vulkan SDK version.
...
# find_package(Vulkan) already reports the authoritative header version.
if(DEFINED Vulkan_VERSION AND NOT Vulkan_VERSION STREQUAL "")
    set(VULKAN_VERSION_TAG "v${Vulkan_VERSION}")
endif()

# Check if the detected version is sufficient for the selected feature set.
if(ENABLE_COURSES)
...
if (VULKAN_VERSION_NUM VERSION_LESS VULKAN_REQUIRED_HEADER_VERSION)
    message(STATUS "Vulkan version ${VULKAN_VERSION_NUM} is less than ${VULKAN_REQUIRED_HEADER_VERSION}. Fetching latest Vulkan-Headers from git...")
