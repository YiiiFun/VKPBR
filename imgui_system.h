...
class ImGuiSystem {
  public:
    ...
    /**
     * @brief Handle vertical mouse wheel input.
     */
    ...
    bool IsBlinnPhongEnabled() const {
      return blinnPhongEnabled;
    }

    void SetBlinnPhongEnabled(bool blinn) {
      blinnPhongEnabled = blinn;
    }
